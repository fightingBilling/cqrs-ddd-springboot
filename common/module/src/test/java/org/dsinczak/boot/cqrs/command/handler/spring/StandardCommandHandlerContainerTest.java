...
import org.dsinczak.boot.common.command.impl.StandardCommandHandlerContainer;
import org.dsinczak.boot.common.cqrs.annotation.Command;
import org.dsinczak.boot.common.cqrs.annotation.CommandHandlerAnnotation;
...
public class StandardCommandHandlerContainerTest {

	private StandardCommandHandlerContainer container;

	@Before
	public void setUp() {
		container = new StandardCommandHandlerContainer(
